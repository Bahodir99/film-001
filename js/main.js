...
let elRay = document.querySelector('.reyting');
let elCat = document.querySelector('.kategoriya');
let elList = document.querySelector('.list');
let elBtn__group = document.querySelector('.btn__group');
...
const mov__slice = movies.slice(10,20)

mapper(mov__slice)
function mapper(mov__slice){
  elList.innerHTML = ''
  mov__slice.map((i) => {
    let NewLi = document.createElement('li');
    NewLi.innerHTML = ` 
      <div class="card">
      <img src="https://i.ytimg.com/vi/${i.ytid}/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLB9-WUeNO830WR5wLWLUv8hRRyOhA" alt="">
...
elYear.addEventListener('change', (e) => {
  e.preventDefault()
  elList.innerHTML = ''
  if (elYear.value == 'yangi') {
    movies.sort((a, b) => b.movie_year - a.movie_year);
    console.log('ok');
  }
  else if (elYear.value == 'eski') {
...
elRay.addEventListener('change', (e) => {
  e.preventDefault()
  elList.innerHTML = ''
  if (elRay.value == 'yuqori') {
    movies.sort((a, b) => b.imdb_rating - a.imdb_rating)
  }
  else if (elRay.value == 'pastki') {
...
elCat.addEventListener('change', (a)=>{
  
  elList.innerHTML = ''

  movies.forEach((e)=>{
    if (e.Categories.indexOf(elCat.value) != -1){
        let NewLi = document.createElement('li');
        NewLi.innerHTML = ` 
            <div class="card">
            <img src="https://i.ytimg.com/vi/${e.ytid}/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLB9-WUeNO830WR5wLWLUv8hRRyOhA" alt="">
...
for (let i = 1; i < count; i++){
  ...
  newBtn.id = i
  elBtn__group.appendChild(newBtn)
}


let elBtn__list = document.querySelectorAll('.page__btn');

elBtn__list.forEach((btn)=>{
...
elForm.addEventListener('submit', (e)=>{
  ...
  elList.innerHTML = ''
  movies.forEach((i)=>{
    if (i.Title.toLocaleUpperCase().includes(elVal.toLocaleUpperCase()) || i.Categories.toLocaleUpperCase().includes(elVal.toLocaleUpperCase())){
      let NewLi = document.createElement('li');
      NewLi.innerHTML = ` 
          <div class="card">
          <img src="https://i.ytimg.com/vi/${i.ytid}/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLB9-WUeNO830WR5wLWLUv8hRRyOhA" alt="">
